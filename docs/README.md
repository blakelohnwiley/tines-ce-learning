...
| **Explanation** | You want to understand why things work this way | [CE operating model](explanation/ce-operating-model.md) · [Alert triage pipelines](explanation/alert-triage-pipelines.md) |

## Diagrams

Architecture diagrams live in [`diagrams/`](diagrams/). Each topic has an editable `.drawio` source and a committed `.drawio.png` export.
