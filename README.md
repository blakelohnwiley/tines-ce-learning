...
6. **Workflow catalog + CE export strategy:** [notes/05-workflow-catalog-and-ce-strategy.md](notes/05-workflow-catalog-and-ce-strategy.md) — 25+ workflow ideas, working around the 3-flow limit.
